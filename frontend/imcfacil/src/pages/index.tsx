...
export default function Login() {
  ...
  const { setUserEmail } = useUser();
   ...
   useEffect(() => {
    ...
    if (token) {
      // Se o token estiver presente, redirecione para a página de perfil
      router.push('/perfil');
    }
  }, []);
              ...
              <div>
                ...
                <div className="mt-2">
                  <input
                    ...
                    className="p-2 block w-full rounded-md border-0 py-1.5 text-gray-300 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                  />
                </div>
              </div>
              <div>
