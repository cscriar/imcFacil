                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-verde-vs600 text-verde-vs400' : 'text-verde-vs600 hover:bg-verde-vs500 hover:text-verde-vs400',
            ...
            <div className="space-y-1 px-2 pt-2 pb-3">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  href={item.href}
                  className={classNames(
                    item.current ? 'bg-verde-vs600 text-verde-vs400' : 'text-verde-vs600 hover:bg-gray-700 hover:text-verde-vs400',
